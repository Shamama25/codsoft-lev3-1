...
mongoose.connect(
  "mongodb+srv://Shamama:shamama25!@cluster0.vcsxrax.mongodb.net/e-commerce"
);
...
//  Create Endpoint for User Register
...
app.post("/signup", async (req, res) => {
  ...
  if (check) {
    return res
      .status(400)
      .json({ success: false, errors: "Email Account already exist!" });
  }
  let cart = {};
  for (let i = 0; i < 300; i++) {
    cart[i] = 0;
...
//  Creating endpoint for adding cart
